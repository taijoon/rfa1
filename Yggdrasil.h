...
enum {
  ...
  TH_INTERVAL = 5120U,
  FX_INTERVAL = 6000U,
	//for THL FX_INTERVAL seems good to have 30 secs.
	//also for the TH_INTERVAL 30 secs
  BASE_INTERVAL = 1024U,
  POW_INTERVAL = 10240U,
  //CO2_INTERVAL = 61440U,
  CO2_INTERVAL = 5120U,
